    ...
    <div class="flex min-h-screen flex-col"> <!-- Flex container untuk mengatur layout halaman -->
        ...
        <div class="container mx-auto flex-grow px-4 py-8 sm:px-6 lg:px-8">
            <div class="mx-auto w-full max-w-2xl rounded-lg bg-white p-8 shadow-md">
                <h2 class="mb-6 text-2xl font-bold">Tambah Laporan</h2> <!-- Judul form tambah laporan -->
                <form action="/laporan/create" method="post"> <!-- Formulir dengan metode POST ke endpoint /laporan/create -->
                    @csrf <!-- Menyertakan token CSRF untuk keamanan form -->

                    <!-- Input Tanggal -->
                    <div class="mb-4">
                        <label for="tanggal" class="mb-2 block text-sm font-bold text-gray-700">Tanggal</label> <!-- Label untuk input tanggal -->
                        <input type="date" name="tanggal" id="tanggal"
                            class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none"> <!-- Input tipe tanggal -->
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="keterangan" id="keterangan" placeholder="Masukkan Keterangan"
                            class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none"> <!-- Input tipe teks -->
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="formatted_nominal" id="formatted_nominal" placeholder="Masukkan Nominal"
                            class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none"> <!-- Input nominal terformat -->
                        <input type="hidden" name="nominal" id="nominal"> <!-- Input tersembunyi untuk nilai nominal tanpa format -->
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="tipe" id="tipe"
                            ...
                            <option value="pemasukan" selected>Pemasukan</option> <!-- Opsi pemasukan -->
                            <option value="pengeluaran">Pengeluaran</option> <!-- Opsi pengeluaran -->
                        </select>
                    </div>
